export const navigation = [
  ...
  },
  {
    title: 'Resources',
    links: [
      { title: 'Books', href: '/posts/resources/books' },
      { title: 'Courses', href: '/posts/resources/courses' },
      {
        title: 'Podcast',
    ...
    links: [
      {
        ...
        href: '/posts/next-js/install-and-overview',
      },
      {
        title: '2. Pages and pre-rendering',
        href: '/posts/next-js/pages-and-pre-rendering',
      },
      {
        title: '3. API routes',
        href: '/posts/next-js/api-routes',
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        href: '/posts/developer-experience/how-to-create-developer-screencasts-with-keynote',
      },
    ],
  },
  {
